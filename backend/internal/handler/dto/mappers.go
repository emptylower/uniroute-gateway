...
func UserFromServiceShallow(u *service.User) *User {
	...
	return &User{
		...
		BillingCurrency:            service.NormalizeUserBillingCurrency(u.BillingCurrency),
...
func APIKeyFromService(k *service.APIKey) *APIKey {
	...
	out := &APIKey{
		...
		ChannelIDs:         append([]int64(nil), k.ChannelIDs...),
		Status:             k.Status,
...
func redeemCodeFromServiceBase(rc *service.RedeemCode) RedeemCode {
	out := RedeemCode{
		...
		Type:         rc.Type,
		Value:        rc.Value,
		Currency:     service.NormalizeUserBillingCurrency(rc.Currency),
		Status:       rc.Status,
		UsedBy:       rc.UsedBy,
		UsedAt:       rc.UsedAt,
...
func usageLogFromServiceUser(l *service.UsageLog) UsageLog {
	...
	return UsageLog{
		...
		SettlementCurrency:        l.SettlementCurrency,
		ExchangeRate:              l.ExchangeRate,
		ExchangeRateSource:        l.ExchangeRateSource,
		ExchangeRateAsOf:          l.ExchangeRateAsOf,
...
func PromoCodeFromService(pc *service.PromoCode) *PromoCode {
	...
	return &PromoCode{
		...
		Currency:    service.NormalizeUserBillingCurrency(pc.Currency),
		MaxUses:     pc.MaxUses,
