...
func (s *inventoryRepositoryStub) List(_ context.Context, cutoff7d, cutoff30d time.Time) ([]InventoryItem, error) {
	s.cutoff7d = cutoff7d
	s.cutoff30d = cutoff30d
	return s.items, s.err
}

func TestModelGovernanceInventoryUsesOneUTCCutoffPairPerRequest(t *testing.T) {
