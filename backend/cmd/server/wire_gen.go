...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	modelGovernanceInventoryAccountSource := repository.NewModelGovernanceInventoryAccountSource(db)
	modelGovernanceInventoryService := service.NewModelGovernanceInventoryService(modelGovernanceInventoryRepository, modelGovernanceInventoryAccountSource)
