...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	modelGovernanceService := service.ProvideModelGovernanceService(modelRegistryService, modelObservationRepository, shadowDecisionRepository, modelClassifier, publicationEvaluator)
