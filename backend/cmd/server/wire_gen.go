...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	accountTestService := service.ProvideAccountTestService(accountRepository, geminiTokenProvider, claudeTokenProvider, grokTokenProvider, antigravityGatewayService, httpUpstream, configConfig, tlsFingerprintProfileService, openAIGatewayService, modelObservationRepository)
	...
	modelGovernanceService := service.ProvideModelGovernanceService(modelRegistryService, modelObservationRepository, shadowDecisionRepository, modelClassifier, publicationEvaluator, endpointProbeChecker)
	...
	channelRoutingSelector := service.ProvideChannelRoutingSelector(channelService, apiKeyService, channelPreferenceService, configConfig)
	...
	modelCatalogService := service.NewModelCatalogService(channelService, channelRoutingSelector, modelPricingResolver, accountRepository, exchangeRateService)
